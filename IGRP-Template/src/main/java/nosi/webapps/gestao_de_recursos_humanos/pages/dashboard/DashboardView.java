...
public class DashboardView extends View {
	...
	public DashboardView(){
		...
		timeline_1 = new IGRPTimeline("timeline_1","Evolução de Contrações");

		paragraph_1_text = new TextField(model,"paragraph_1_text");
		paragraph_1_text.setLabel(gt(""));
		paragraph_1_text.setValue(gt("<p><span style='font-family:Comic Sans MS,cursive;'><span style='font-size:28px;'>A empresa est&aacute; crescendo, vamos ver o hist&oacute;rico de contrata&ccedil;&otilde;es</span></span></p>"));
		...
		timeline_1_btn.propertie().add("type","link").add("target","modal").add("maxlength","4000");
		


		btn_filtrar = new IGRPButton("Filtrar","gestao_de_recursos_humanos","Dashboard","filtrar","submit_ajax","grey|fa-filter","","");
	...
	public void setModel(Model model) {
		...
		timeline_1.loadModel(((Dashboard) model).getTimeline_1());
		}
}
